...
exports.SALT_SPACE = 7 * 24 * 60 * 60;

exports.KEY = 'DUMMY_KEY';
...
// @return {number} the computed salt
// ```
exports.salt = function(str) {
  var b = new Buffer(exports.hash([str.toString()], 'binary'), 'binary');
  return (b.readUInt32BE(0) % exports.SALT_SPACE);
};
